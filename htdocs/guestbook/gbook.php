...
if ($total > 0) {
    ...
    for ($i=1; $i<=$pages; $i++) {
        if ($i <= ($page+5) && $i >= ($page-5)) {
           ...
           else {$gbook_nav .= ' <a href="'.$_SERVER['SCRIPT_NAME'].'?page='.$i.'">'.$i.'</a> ';}
        }
    }
    ...
    if ($next_page) {
        ...
        &nbsp;|&nbsp;
        <a href="'.$_SERVER['SCRIPT_NAME'].'?page='.$pages.'">Last &gt;&gt;</a>
        ';
    }
...
<p><a href="<?=$_SERVER['SCRIPT_NAME']?>?page=1">Click here to continue</a></p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
...
<p>&nbsp;</p>
<p style="text-align:center"><input type="submit" value="View IP" /> | <a href="<?=$_SERVER['SCRIPT_NAME']?>">Cancel / Go back</a>
...
?>
<p style="text-align:center"><input type="submit" value="Post reply" /> | <a href="<?=$_SERVER['SCRIPT_NAME']?>">Cancel / Go back</a>
...
<form action="<?=$_SERVER['SCRIPT_NAME']?>?<?php echo strip_tags(SID);?>" method="post" name="form"><input type="hidden" name="a" value="add" />
...
<td class="upper" style="width:65%"><b>Comment:</b></td>
</tr>
<tr>
...
<a href="'.$_SERVER['SCRIPT_NAME'].'?a=delete&amp;num='.$num.'"><img src="images/cross-script.png" width="14" height="14" alt="Delete this entry" style="border:none" /></a>
&nbsp;
</td>
</tr>
</table>
...
<p style="text-align:center"><a href="'.$_SERVER['SCRIPT_NAME'].'">Back to Guestbook</a></p>
';
...
<p>&nbsp;</p>
<p style="text-align:center"><input type="submit" value="Read private post" /> | <a href="<?=$_SERVER['SCRIPT_NAME']?>">Cancel / Go back</a>
...
<p>&nbsp;</p>
<p style="text-align:center"><input type="submit" value="Delete this entry" /> | <a href="<?=$_SERVER['SCRIPT_NAME']?>">Cancel / Go back</a>
...
';
    ...
    if (empty($isprivate) || empty($settings['use_private'])) {echo $comment;}
        ...
        echo '<p>&nbsp;</p>
        <p><i><a href="'.$_SERVER['SCRIPT_NAME'].'?a=viewprivate&amp;num='.$i.'">Private post. Click to view.</a></i></p>';
    }
...
<td style="width:50%; text-align:right">
<a href="'.$_SERVER['SCRIPT_NAME'].'?a=delete&amp;num='.$i.'"><img src="images/cross-script.png" width="14" height="14" alt="Delete this entry" style="border:none" /></a>
&nbsp;
</td>
</tr>
</table>
...
| <a href="'. $_SERVER['SCRIPT_NAME'].'">View guestbook</a>
| <a href="'. $_SERVER['SCRIPT_NAME'].'?a=sign">Sign guestbook</a></p>
<div class="centered">
';
} // END printTopHTML
